...
%Kopfzeile
\fancyhead[L]{\small{\nouppercase{\leftmark}}}%
\fancyhead[R]{\small{Volker Karle, Thomas Reichenbach, Felix Göpfert}}
%Linie oben
...
\begin{large}
\begin{tabular}{ll}\\\\\\
\multicolumn{2}{p{14.0cm}}{\centering \huge\bf Beispieltext
}\\[20mm]
\hline \\
\textbf{Name}:    & diverse Menschen\\[6mm]
\textbf{Betreuer:}&  noch diversere Menschen\\[6mm]
